...
- (BOOL)isValidIdCardNum
{
    ...
    // 省份代码
    NSArray *provincesArray =@[@"11", @"12", @"13", @"14", @"15", @"21", @"22", @"23", @"31", @"32", @"33", @"34", @"35", @"36", @"37", @"41", @"42", @"43", @"44", @"45", @"46", @"50", @"51", @"52", @"53", @"54", @"61", @"62", @"63", @"64", @"65", @"71", @"81", @"82", @"91"];
    NSString *valueStart2 = [value substringToIndex:2];
    BOOL provinceFlag = NO;
    for (NSString *provinceCode in provincesArray) {
        if ([provinceCode isEqualToString:valueStart2]) {
            provinceFlag = YES;
            break;
        }
    }
